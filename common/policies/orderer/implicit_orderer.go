...
type policyProvider struct {
	signaturePolicyProvider *cauthdsl.ProviderFromStruct
...
func (p *policyProvider) NewPolicy(data []byte) (policies.Policy, proto.Message, error) {
	...
	sigPol, err := p.signaturePolicyProvider.NewPolicy(sigEnv)
	if err != nil {
...
func (ip *implicitBFTPolicy) Evaluate(signatureSet []*protoutil.SignedData) error {
